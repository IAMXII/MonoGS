...
def get_loss_tracking(config, image, depth, opacity, viewpoint, initialization=False):
    ...
    #     return get_loss_tracking_rgb(config, image_ab, depth, opacity, viewpoint)   ### liuwei
...
def get_loss_tracking_rgbd(
    ...
    gt_depth = torch.from_numpy(viewpoint.depth * viewpoint.scale).to(
...
def get_loss_mapping(config, image, depth, viewpoint, opacity, initialization=False):
    if initialization:
        ...
        image_ab = (torch.exp(viewpoint.exposure_a)) * image + viewpoint.exposure_b
    # if config["Training"]["monocular"]:
    #     return get_loss_mapping_rgb(config, image_ab, depth, viewpoint)  ### liuwei
